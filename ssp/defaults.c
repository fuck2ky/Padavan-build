...
struct nvram_pair router_defaults[] = {
	...
	{ "block_douyin", "0" },
	{ "anti_ad", "0" },
	{ "anti_ad_link", "https://cdn.jsdelivr.net/gh/privacy-protection-tools/anti-AD/adblock-for-dnsmasq.conf" },
	{ "anti_ad_count", "0" },
	/* Pdnsd */
	{ "dns_enable", "0" },
	...
	{ "trojan_link", "https://cdn.jsdelivr.net/gh/fuck2ky/Padavan-build/ssp/trojan" },
	{ "v2_local_enable", "0" },
	{ "v2_local", "/tmp/v2ray" },
	{ "v2_link", "https://cdn.jsdelivr.net/gh/fuck2ky/Padavan-build/ssp/v2ray" },
	{ "ss_mode", "1" },
	{ "ss_server", "127.0.0.1" },
	{ "ss_server_port", "8989" },
	{ "ss_key", "Secret" },
